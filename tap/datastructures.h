...
/* Comment out this line to disable memory leak checking */
/* #define MEMCHECK */
#define MEMCHECK_THRESHOLD 1000 /* Threshold before reporting data structure counts for memory leak checking */
...
#ifdef MEMCHECK
long memcheck_numScalars, memcheck_numVectors, memcheck_numMatrices, memcheck_num3DArrays;
#endif
